...
def Astar(goal_position1,start,obstacle_positions):
    # INTIALIZE HERE
    min_x=0
    max_x=100
    min_y=0
    ...
    y_start = start[1]
    agent_radius  = .5
    print("goal",goal_position1,'start',start)
    goal_position = [goal_position1[0],goal_position1[1]] 
    print("gp",goal_position)
